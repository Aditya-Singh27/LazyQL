...
LazyQL enforces **read-only SQL access** through two independent layers:
...
LazyQL enforces **read-only database interaction** through defense in depth — safety isn't left to the AI's judgment alone.
